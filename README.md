...
> ⚠️ Это `README.md`, он содержит только краткую информацию. Полная документация, инструкции по установке и руководство пользователя находятся в файле [docs/bot_manual.docx](docs/bot_manual.docx).
